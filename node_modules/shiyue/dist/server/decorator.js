...
exports.ParamsRequired = exports.ParamsDefaultValue = exports.Decorate = exports.Use = void 0;
...
function ParamsDefaultValueHandler(key, dvalue) {
    return (ctx) => {
...
function ParamsDefaultValue(key, dvalue) {
    return Use(ParamsDefaultValueHandler(key, dvalue));
}
exports.ParamsDefaultValue = ParamsDefaultValue;
function ParamsRequired(key, err_msg = null) {
    return Use(function (ctx) {
        if (!Object.prototype.hasOwnProperty.call(ctx.params(), key)) {
            if (err_msg === null) {
                err_msg = key + "参数缺失";
            }
